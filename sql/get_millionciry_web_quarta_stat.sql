#get_millionciry_web_quarta_stat
WITH

week_37_49 AS
(SELECT
"москва" AS city,
SUM(leads_msk) AS leads_total_49,
SUM(leads_msk_yandex) AS leads_yandex_49,
SUM(leads_msk_google) AS leads_google_49,
0 AS ya_cost_49,
0 AS goo_cost_49
FROM ds_SA_weekly.tb_millioncity_web_stat_weekly
WHERE
year_num = 2020 AND
...
ORDER BY leads_total_49),

week_24_36 AS
(SELECT
"москва" AS city,
SUM(leads_msk) AS leads_total_36,
SUM(leads_msk_yandex) AS leads_yandex_36,
SUM(leads_msk_google) AS leads_google_36,
0 AS ya_cost_36,
0 AS goo_cost_36
FROM ds_SA_weekly.tb_millioncity_web_stat_weekly
WHERE
...
ORDER BY leads_total_36)

SELECT *,
ROUND(SAFE_DIVIDE(week_37_49.ya_cost_49, week_37_49.leads_yandex_49), 2) AS ya_lead_cost_49,
ROUND(SAFE_DIVIDE(week_37_49.goo_cost_49, week_37_49.leads_google_49), 2) AS goo_lead_cost_49,
ROUND(SAFE_DIVIDE(week_24_36.ya_cost_36, week_24_36.leads_yandex_36), 2) AS ya_lead_cost_36,
ROUND(SAFE_DIVIDE(week_24_36.goo_cost_36, week_24_36.leads_google_36), 2) AS goo_lead_cost_36
FROM
week_37_49
FULL OUTER JOIN
week_24_36
USING(city)
ORDER BY
(week_37_49.leads_total_49 + week_24_36.leads_total_36)