#get_millionciry_cntx_quarta_stat
WITH
...
SELECT *,
ROUND(SAFE_DIVIDE(week_37_49.ya_cost, week_37_49.leads_yandex), 2) AS ya_lead_cost_49,
ROUND(SAFE_DIVIDE(week_37_49.goo_cost, week_37_49.leads_google), 2) AS goo_lead_cost_49,
ROUND(SAFE_DIVIDE(week_24_36.ya_cost, week_24_36.leads_yandex), 2) AS ya_lead_cost_36,
ROUND(SAFE_DIVIDE(week_24_36.goo_cost, week_24_36.leads_google), 2) AS goo_lead_cost_36
FROM
week_37_49
FULL OUTER JOIN
week_24_36
