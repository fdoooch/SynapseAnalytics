...
AmoLeads AS
(SELECT
  EXTRACT(ISOWEEK FROM created_at) AS week_num,
  COUNTIF(pipeline_id = 7038) AS cntx_all_leads_count,
  COUNTIF(pipeline_id = 28752) AS web_all_leads_count,
  COUNTIF(pipeline_id = 7038 AND status_id = 28985871) AS cntx_trash_leads_count,
  COUNTIF(pipeline_id = 28752 AND status_id = 29160522) AS web_trash_leads_count,
  COUNTIF(pipeline_id = 7038 AND status_id = 142) AS cntx_won_leads_count,
  COUNTIF(pipeline_id = 28752 AND status_id = 142) AS web_won_leads_count,
FROM ds_garpun_amocrm_deals.amocrm_syn
GROUP BY week_num)
